    ...
    <SafeAreaView style={styles.container} edges={['top', 'bottom']}>
      ...
      >
        ...
        <View style={styles.body}>
          <TouchableOpacity style={styles.editCta} onPress={handleEdit} activeOpacity={0.8}>
            <Text style={styles.editCtaText}>Edit venue</Text>
          </TouchableOpacity>
          ...
          <View style={styles.ownerActions}>
            <TouchableOpacity
              ...
              onPress={() =>
                navigation.navigate('SubmissionsReview', {
                  token,
                  user: params?.user,
                  venueId: venue.id,
                  venue,
            ...
            >
              <Text style={styles.ownerActionBtnText}>Review submissions</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.ownerActionBtn}
              onPress={() =>
                navigation.navigate('VenueRedemptions', {
                  token,
                  user: params?.user,
                  venueId: venue.id,
                  venue,
            ...
            >
              <Text style={styles.ownerActionBtnText}>Redemptions</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={styles.ownerActionBtn}
              onPress={() =>
                navigation.navigate('VenuePerks', {
                  token,
                  user: params?.user,
                  venueId: venue.id,
                  venue,
            ...
            >
              <Text style={styles.ownerActionBtnText}>Perks</Text>
            </TouchableOpacity>
          </View>
          ...
          {venueMediaLoading ? (
            <ActivityIndicator size="small" color="#059669" style={styles.mediaLoader} />
          ) : venueMedia.length === 0 ? (
          ...
          {perksLoading ? (
            <ActivityIndicator size="small" color="#059669" style={styles.perksLoader} />
          ) : perks.length === 0 ? (
...
const styles = StyleSheet.create({
  ...
  editHeaderBtnText: { fontSize: 14, fontWeight: '600', color: '#fff' },
  scroll: { flex: 1 },
  scrollContent: { paddingBottom: 32 },
  imageWrap: { width: '100%', height: 220, backgroundColor: '#e2e8f0' },
  ...
  editCtaText: { color: '#fff', fontSize: 16, fontWeight: '600' },
  ownerActions: {
    flexDirection: 'row',
    flexWrap: 'wrap',
    gap: 12,
  ...
  ownerActionBtnText: { fontSize: 14, fontWeight: '600', color: '#fff' },
  name: { fontSize: 24, fontWeight: '700', color: '#111', marginBottom: 6 },
  category: { fontSize: 14, color: '#059669', fontWeight: '600', marginBottom: 10, textTransform: 'capitalize' },
  ...
  pointsValue: { fontSize: 14, fontWeight: '600', color: '#111' },
  sectionTitle: { fontSize: 18, fontWeight: '700', color: '#111', marginTop: 24, marginBottom: 12 },
  perksLoader: { marginVertical: 12 },
  noPerks: { fontSize: 14, color: '#94a3b8', marginBottom: 8 },
  perkCoverImage: {
    width: '100%',
    height: 100,
  ...
  perkTitle: { fontSize: 16, fontWeight: '600', color: '#111', marginBottom: 4 },
  perkDesc: { fontSize: 14, color: '#64748b', marginBottom: 6 },
  perkPoints: { fontSize: 13, color: '#059669', fontWeight: '600' },
  mediaLoader: { marginTop: 8, marginBottom: 16 },
  noMedia: { fontSize: 14, color: '#64748b', marginTop: 4, marginBottom: 16 },
  mediaGrid: { flexDirection: 'row', flexWrap: 'wrap', gap: 8, marginTop: 8, marginBottom: 16 },
  mediaItem: {
    width: '30%',
    aspectRatio: 1,
    borderRadius: 8,
  ...
  mediaVideoLabel: { color: '#f9fafb', fontSize: 13, fontWeight: '600' },
  mediaModalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.9)', justifyContent: 'center' },
  mediaModalClose: {
    position: 'absolute',
    top: 48,
    right: 16,
  ...
  backBtn: { paddingVertical: 10, paddingHorizontal: 20, backgroundColor: '#e2e8f0', borderRadius: 8 },
  backBtnText: { fontSize: 15, fontWeight: '600', color: '#334155' },
});
